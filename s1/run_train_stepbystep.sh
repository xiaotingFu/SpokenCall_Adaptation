...
# This script is used to train the JJJ ASR system.
# Mengjie Qian, 2017-9-16

# Note: step 0, step 1 and some decoding commands can be skipped. Please do not run this script directly,
# choose the steps you need, otherwise you will replace our provided features and language model.
...
data_dir_sub=data/sharedTask/all
...
local/sharedTask_train_lms.sh data/sharedTask/all/text data/sharedTask/all/text \
...
steps/train_mono.sh --nj 1 --cmd queue.pl data/sharedTask/st_ihm20_psgAll/train10 data/lang_v1 exp10/mono
# alignment
