...
def prepareKaldiTestData_textonly(prefix, dest):
    # prepare utterance
    # prepare wavefile
    textFile = dest+'/text'
    # wav_scpFile =dest+'/wav.scp'
...
def prepareKaldiData_textonly(prefix, csvPath,audioPath, dest):
    # Generating Kaldi format files for ASR training
    textFile = dest+'/text'
    # wav_scpFile =dest+'/wav.scp'
    # utt2spkFile =dest+'/utt2spk'
    ...
    with open(csvPath) as csvfile:
            ...
            for row in readCSV:
                ...
                row_number=row_number+1
def main():
    prepareKaldiData_textonly('01',train_label_1st, audio_1st, destination_train)
    prepareKaldiData_textonly('01',test_label_1st, audio_1st, destination_train)
    prepareKaldiData_textonly('02',train_label_A_2nd, train_audio_2nd,destination_train)
    prepareKaldiData_textonly('02',train_label_B_2nd, train_audio_2nd,destination_train)
    prepareKaldiData_textonly('02',train_label_C_2nd, train_audio_2nd,destination_train)
    prepareKaldiTestData_textonly('sc2', destination_test)
main()